...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void _handleSave() {
    if (_formKey.currentState!.validate()) {
      ...
      final hasNameOrBioChange =
          name != widget.user.name || bio != widget.user.bio;
          ...
          if (state is AvatarUploadSuccess && _shouldUpdateProfileAfterAvatar) {
            ...
            context.read<ProfileBloc>().add(
              ...
              (state is AvatarUploadSuccess &&
                  !_shouldUpdateProfileAfterAvatar)) {
  ...
  Widget _buildBody(BuildContext context, bool isUpdating) =>
