...
class NoteAttachmentModel extends NoteAttachment {
  const NoteAttachmentModel({required super.type, required super.id});

  /// Creates [NoteAttachmentModel] from [NoteAttachment]
  factory NoteAttachmentModel.fromEntity(NoteAttachment entity) =>
      NoteAttachmentModel(type: entity.type, id: entity.id);
  ...
  @override
  NoteAttachmentModel copyWith({String? type, String? id}) =>
      NoteAttachmentModel(type: type ?? this.type, id: id ?? this.id);
}
...
class NoteModel extends Note {
  ...
  factory NoteModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return NoteModel.fromJson({'id': doc.id, ...data});
  }
